...
# Reward Q ta
def getReward(action, prev_action, lidar, prev_lidar, crash, done):
    if crash:
        terminal_state = True
        reward = -100
    else:
        ...
        if action == 0:
            ...
            r_action = -0.1
        # Reward khoang vat the thay doi
        ...
        reward = r_action + r_obstacle + r_change + r_goal
